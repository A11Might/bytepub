...
{cleaned_html}
    ...
    if fmt in ("epub", "all"):
        ...
        build_epub(course_slug.replace("-", " ").title(), [cleaned], epub_path, assets_dir, cache_dir=output_dir, pw=pw)
...
{cleaned_html}
        ...
        if fmt in ("epub", "all"):
            ...
            build_epub(course_slug.replace("-", " ").title(), cleaned_pages, epub_path, assets_dir, cover_path, cache_dir=output_dir, pw=pw)
